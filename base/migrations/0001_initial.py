    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(default='wcl_code', max_length=50, unique=True, verbose_name='wcl report code')),
                ...
                ('upload_time', models.DateTimeField(default=datetime.datetime(2020, 9, 10, 6, 49, 17, 117679))),
                ('scan_flag', models.CharField(default='{}', max_length=1000)),
            ],
        ),
        migrations.CreateModel(
            name='Friendly',
